...
export class UpdateElectionConstraints1552175011647 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "election_positions" ADD CONSTRAINT "FK_e1ca173f778f74aa98b03a40948" FOREIGN KEY ("election_id") REFERENCES "elections"("id") ON DELETE CASCADE`);
    }
